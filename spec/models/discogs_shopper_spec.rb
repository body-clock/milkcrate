...
RSpec.describe DiscogsShopper do
  describe "validations" do
    ...
    it "allows case-insensitive usernames via scope" do
      create(:discogs_shopper, discogs_username: "TestUser")
      expect(described_class.with_discogs_username("testuser")).to exist
    end
  end
