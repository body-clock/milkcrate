  ...
  return {
    ...
    records: [
      ...
      },
      {
        ...
        thumbnail_url: null,
        notes: null,
        discogs_url: "https://www.discogs.com/sell/item/3",
      },
      {
        id: 4,
        discogs_listing_id: "4",
        artist: "Artist 4",
        title: "Record 4",
        label: null,
        year: null,
        ...
        thumbnail_url: null,
        notes: null,
        discogs_url: "https://www.discogs.com/sell/item/4",
      },
    ],
    ...overrides,
  };
...
describe("interactive accessibility", () => {
  ...
  it("exposes crate riffle controls and progress with front/deeper language", () => {
    ...
    expect(
      screen.getByRole("progressbar", { name: "Record 1 of 4, front to deeper" }),
    ).toBeInTheDocument();
  });
});
...
describe("no nested interactive controls", () => {
  ...
  it("keeps record actions keyboard-focusable through the canonical focus role", () => {
    ...
    expect(screen.getByRole("button", { name: "+ Pile" })).toHaveClass(
      "focus-visible:ring-mc-focus",
    );
    expect(screen.getByRole("link", { name: /Discogs/ })).toHaveClass(
      "focus-visible:ring-mc-focus",
    );
  });
