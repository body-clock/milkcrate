...
describe("RecordTile / props", () => {
  ...
  it("sets image loading attribute", () => {
    renderTile({ listing: makeListing({ cover_image_url: "https://example.com/cover.jpg" }), imageLoading: "eager" })
...
describe("RecordTile / accessibility", () => {
  it("images have alt text from the listing title", () => {
    renderTile({ listing: makeListing({ title: "Dark Side of the Moon", cover_image_url: "https://example.com/cover.jpg" }) })
