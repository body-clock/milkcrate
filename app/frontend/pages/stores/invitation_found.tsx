...
export default function InvitationFound({
  ...
  return (
    <motion.div initial={fadeInAnim} animate={visibleAnim} transition={fadeIn} className="w-full">
      <motion.h1 initial={fadeInAnim} animate={visibleAnim} transition={fadeInDelay1} className="text-2xl font-bold text-mc-text mb-3">
        We found <span className="text-mc-accent">{sellerName}</span> on Discogs
      </motion.h1>
      <motion.p initial={fadeInAnim} animate={visibleAnim} transition={fadeInDelay2} className="text-sm text-mc-text-dim leading-relaxed max-w-sm mx-auto mb-8">
        This URL could be your storefront. Claim it to show your Discogs inventory as a browsable, curated record store.
      </motion.p>
      <motion.div initial={fadeInAnim} animate={visibleAnim} transition={fadeInDelay3} className="space-y-3">
