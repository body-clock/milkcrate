...
export default function StoreShowContent(props: Props) {
  ...
  if (props.crates.length === 0) {return <EmptyCratesState />;}
  return (<>
    ...
    <BrowseShell
      ...
      activeSlug={props.activeSlug} startIndex={props.startIndex}
      selectCrate={props.selectCrate} backToStore={props.backToStore}
      directEntry={props.directEntry}
      crates={props.crates} listingCount={props.listingCount}
      genreCount={props.storefront_sections.find((s) => s.key === "genre_grid")?.crates?.length ?? 0}
    />
  </>);
}
