...
export function PanelView({ isBusy, state, username, createPath, csrfToken, onUsernameChange, onLookup }: PanelViewProps) {
  return (
    <CardContent className="space-y-4">
      <LookupForm username={username} isBusy={isBusy} onUsernameChange={onUsernameChange} onLookup={onLookup} />
