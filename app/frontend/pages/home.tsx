    ...
    <MarketingLayout>
      <div className="flex flex-col items-center justify-center text-center px-6 py-20 max-w-sm mx-auto">
        ...
        <h1 className="text-2xl font-bold mc-text mb-3 leading-snug">
          Your Discogs inventory, but discoverable.
        </h1>
        <p className="text-sm text-mc-text-dim mb-10 leading-relaxed">
          Milkcrate turns your Discogs inventory into a digital storefront worth sharing.
        </p>
        ...
        <div className="flex flex-col items-center gap-3 w-full max-w-xs">
          ...
          >
            Get your store on Milkcrate
          </Link>
        </div>

        <p className="mt-6 text-xs text-mc-text-dim">Free to start. We handle the setup.</p>
      </div>
    </MarketingLayout>
  )
}
