...
module CrateStrategies
  ...
  # ---------------------------------------------------------------------------
  # Hidden Gems — records with low total Discogs engagement (<= 100 combined
  # wants + haves) but wants outstripping haves. Obscure enough to be missed,
  # desirable enough to be worth surfacing.
  # ---------------------------------------------------------------------------
  class HiddenGems
    MIN_RECORDS     = 4
    PER_GENRE_CAP   = 3
